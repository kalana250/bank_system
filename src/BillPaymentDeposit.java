 ...
 * @author mcs
 */
public class BillPaymentDeposit extends javax.swing.JFrame implements Runnable{

    /**
     * Creates new form BillPaymentDeposit
     */
    public BillPaymentDeposit() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BILL PAYMENT DEPOSIT");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
          ...
          if(rs.next()){
              ...
              BillPayDepositConfirm a = new BillPayDepositConfirm(amount, acc_no, fn);
              a.setVisible(true);
              this.dispose();
          }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillPaymentDeposit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillPaymentDeposit().setVisible(true);
            }
        });
    }
